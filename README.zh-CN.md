...
它还有一个很重要的价值：许多工作中的 context 可以由 AI 主动生成和持续维护，这既降低了人工文档成本，也让 AI 在维护这些 context 的过程中不断整理、刷新并稳定自己对代码库的 awareness。
...
在 RCOS 里，context 不只是给 AI 读取的材料，也是 AI 用来主动生成、维护并持续刷新自身代码库理解的一层协作基础设施。
